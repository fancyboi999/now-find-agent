...
------------      -------    --------    -----------
2022/11/17 14:08   zengxinmin@nowcoder.com   1.0         None
"""
import re
import time
...
class StrUtil:
    ...
    def progress_bar():
        ...
        for i in range(t + 1):
            ...
            logger.info(f"\r{progress:^3.0f}%[{finsh}->{need_do}]{dur:.2f}s")
            time.sleep(0.05)
...
if __name__ == "__main__":
    ...
    #
    # logger.info(StrUtil.sub_str_after("/Users/zengxinmin@nowcoder.com/Softs/workspaces-py/now-find-agent", "/", True))
    #
